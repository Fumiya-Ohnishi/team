...
<body>
    ...
    <main>
        ...
        <div class="main2_img">
            <img src="../photographer/img/building/img9.jpg" />
        </div>
        ...
        <div id="kodawari" class="kodaawri">
            ...
            <div class="kodawari_img">
                <img src="../photographer/img/建築写真は・・.jpg" />
            </div>
        </div>
        ...
        <div id="move" class="move_wrapper">
            ...
            <div class="move_space">
                <div class="move_img">
                    <img src="../photographer/img/building/img5.jpg" />
                    <img src="../photographer/img/building/img21.jpg" />
                </div>
                <div class="move_text_wrapper">
                    ...
                    <div class="move_text">
                        <ul>
                            ...
                            <li>
                                撮影内容に関しては、バックになる背景の素材準備、小道具の準備等が
                            </li>
                            <li>
                                ございますので、なるべく早く詳細をご連絡して下さい。
                            </li>
                        </ul>
                    </div>
                    <div class="move_sub_title">
                    ...
                    <div class="move_text">
                        <ul>
                            <li>
                                決定したお時間の１時間～３０分前には機材搬入の為
                            </li>
                            <li>
                                撮影現場に入ります。
                            </li>
                            <li>
                                カットづつモニター画面で確認させて頂きながら、
                            </li>
                            <li>
                                ご希望の写真をつくって行きます。
                            </li>
        ...
        <div class="building_img">
            <img class="img1 fadeInTrigger" src="../photographer/img/building/img11.jpg" />
            <img class="img2 fadeInTrigger" src="../photographer/img/building/img12.jpg" />
            <img class="img3 fadeInTrigger" src="../photographer/img/building/img20.jpg" />
            <img class="img4 fadeInTrigger" src="../photographer/img/building/img23.jpg" />
            <img class="img5 fadeInTrigger" src="../photographer/img/building/img29.jpg" />
        </div>
